...
import com.abraaofaher.spring_mongodb.dto.AuthorDTO;
import com.abraaofaher.spring_mongodb.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws ParseException {
        ...
        CommentDTO c3 = new CommentDTO("Tenha um oimo dia!", sdf.parse("23/03/2018"), new AuthorDTO(alex));
